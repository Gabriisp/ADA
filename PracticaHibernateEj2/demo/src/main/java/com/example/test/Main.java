...
public class Main {
    ...
    private static conferencia crearconferencia(String nombre, String fecha, String lugar, double horas) throws Exception {
    ...
    //  Crear asistencia a conferencia
    ...
    // PARTE b): INSERTAR DATOS - CON FECHAS NORMALES
    private static void insertarDatos() throws Exception {
        ...
        investigador inv1 = crearinvestigador("30487452M", "Juan Pérez Martínez", "C./ Desengaño 21", "623423523", "Cádiz");
        ...
        investigador inv4 = crearinvestigador("67534312A", "Pablo Fernández Feria", "Avd. Inventada 15", "613442323", "Cádiz");
        ...
        // 5. Crear conferencias CON FECHAS NORMALES (solo 4 conferencias)
        ...
        // Investigador 2 -> Conferencias 1, 3 (Luisa Puertas)
        ...
        // Investigador 4 -> Conferencia 1 (Pablo Fernández)
