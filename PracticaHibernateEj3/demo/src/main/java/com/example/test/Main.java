...
public class Main {
    ...
    private static void ejecutarActualizaciones() {
        ...
        try {
            ...
            if (p3 != null) {
                ...
                int asignados = 0;
                // Para cada investigador: asignar proyecto 3
    ...
    private static void ejecutarEliminaciones() {
        ...
        try {
            ...
            investigador inv2 = em.find(investigador.class, "45768434R");
            if (inv2 != null) {
                // Primero eliminar sus asistencias a conferencias
            ...
            if (p1 != null) {
                // Primero debemos desasociar a los investigadores del proyecto 1
                // Obtener investigadores del proyecto 1
